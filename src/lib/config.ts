...
const envSchema = z.object({
  ...
  MANUAL_TOP_UP_ENABLED: z.enum(["true", "false"]).default("false"),
  MANUAL_TOP_UP_BANK_NAME: z.string().optional(),
  MANUAL_TOP_UP_ACCOUNT_NAME: z.string().optional(),
  MANUAL_TOP_UP_ACCOUNT_NUMBER: z.string().optional(),
  MANUAL_TOP_UP_WECHAT_ID: z.string().optional(),
  MANUAL_TOP_UP_CONTACT: z.string().optional(),
  MANUAL_TOP_UP_NOTE: z.string().optional(),
...
const parsed = envSchema.parse({
  ...
  MANUAL_TOP_UP_ENABLED: process.env.MANUAL_TOP_UP_ENABLED,
  MANUAL_TOP_UP_BANK_NAME: process.env.MANUAL_TOP_UP_BANK_NAME,
  MANUAL_TOP_UP_ACCOUNT_NAME: process.env.MANUAL_TOP_UP_ACCOUNT_NAME,
  MANUAL_TOP_UP_ACCOUNT_NUMBER: process.env.MANUAL_TOP_UP_ACCOUNT_NUMBER,
  MANUAL_TOP_UP_WECHAT_ID: process.env.MANUAL_TOP_UP_WECHAT_ID,
  MANUAL_TOP_UP_CONTACT: process.env.MANUAL_TOP_UP_CONTACT,
  MANUAL_TOP_UP_NOTE: process.env.MANUAL_TOP_UP_NOTE,
...
export const env = {
  ...
  MANUAL_TOP_UP_ENABLED: parsed.MANUAL_TOP_UP_ENABLED === "true",
